...
describe('useSendMessage Hook', () => {
  ...
  it('should set loading to true initially and false after message is sent successfully', async () => {
  ...
  it('should call setMessages with the new message on successful message send', async () => {
  ...
  it('should call the API with the correct URL, headers, and message payload', async () => {
    axios.post.mockResolvedValueOnce({ data: { message: 'Hello' } });
